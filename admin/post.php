...
<div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active">Manage All User Post </li>
                </ol>
            </div><!-- /.col -->
            </div><!-- /.row -->
           </div><!-- /.container-fluid -->
                            ...
                            <h3 class="card-title">Manage users</h3>
                             ...
                             <table class="table table-bordered table-striped table-hover justify-content-center">
                                ...
                                <?php 
                                    ...
                                    $postdb = mysqli_query($db, $sql);
                                    $i=0;
                                    while( $row = mysqli_fetch_assoc($postdb) ){
                                        $id              = $row['id'];
                                        $title           = $row['title'];
                                    ...
                                    <td>
                                        <?php 
                                            if(!empty($image)){?>
                                                <img src="img/post/<?php echo $image; ?>" alt="" width="35">
                                            <?php }else{ ?>
                                    ...
                                    <div class="action-bar">
                                        <ul class="justify-content-center">
                                           <li>
                                            <a href="post.php?do=edit&id=<?php echo $id; ?>"><i class="fa fa-edit"></i></a>
                                            </li>
                                            <li>
                                    ...
                                    <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-footer text-center">
                                                ...
                                                <a href="post.php?do=delete&id=<?php echo $id; ?>"class="btn btn-primary btn-danger"> Yes</a>
...
<?php }elseif($do == 'insert'){
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (!empty($image)) {
            ...
            $imagenew = rand(0,5000000) . '_' . $image;

            $destination = 'img/post/'.$imagenew ;

            move_uploaded_file($imageTmp, $destination);

            $sql = "INSERT INTO post (title, description, image, category_id, author_id, status, tags, post_date) 
            VALUES ('$title','$des','$image','$category','$author_id','$status','$tag',now())";
